#include <Cipher.h>
/**
 * @brief Конструктор, принимающий на вход ключ, устанавливает кол-во столбцов
 * @param ws_key
...
/**
 * @brief Метод, принимающий на вход ключ, устанавливает кол-во столбцов
 * @param ws_key
 * @return Ничего не возвращает
 */
...
/**
 * @brief Принимает текст для зашифровки,
 далее по нему формирует кол-во строк в таблице,
 а также получает длину текста.
 * @param open_text
 */
 ...
 * Строчные буквы превращаются в прописные. Все не-буквы удаляются.
 * @param ws_open_text
